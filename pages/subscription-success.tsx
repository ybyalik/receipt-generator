      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
        <div className="bg-white rounded-2xl shadow-xl p-12">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/templates"
              className="inline-flex items-center justify-center px-8 py-3 rounded-xl font-semibold transition-all shadow-lg cursor-pointer"
            ...
            <Link
              href="/my-templates"
              className="inline-flex items-center justify-center bg-white text-gray-900 border-2 border-gray-200 px-8 py-3 rounded-xl font-semibold hover:bg-gray-50 transition-all cursor-pointer"
            >
              My Templates
            </Link>
          </div>
