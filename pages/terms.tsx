      ...
      <div className="min-h-screen bg-gray-50 py-12">
        <div className="max-w-4xl mx-auto px-4">
          <div className="bg-white rounded-lg shadow-md p-8">
            ...
            <h2 className="text-2xl font-bold text-navy-900 mt-8 mb-4">3. Prohibited Uses</h2>
            ...
            <h2 className="text-2xl font-bold text-navy-900 mt-8 mb-4">4. User-Generated Content and Intellectual Property</h2>
            ...
            <p>If you believe your intellectual property rights are being infringed, please contact us at <a href="mailto:contact@receiptgenerator.net" className="text-navy-600 hover:text-navy-800 underline">contact@receiptgenerator.net</a>.</p>

            <h2 className="text-2xl font-bold text-navy-900 mt-8 mb-4">5. Storage and Use of Generated Receipts</h2>
            ...
            <h2 className="text-2xl font-bold text-navy-900 mt-8 mb-4">6. User Responsibility</h2>
            ...
            <h2 className="text-2xl font-bold text-navy-900 mt-8 mb-4">9. Payment and Refund Policy</h2>
            ...
            <h2 className="text-2xl font-bold text-navy-900 mt-8 mb-4">10. Termination of Access</h2>
            ...
            <p>If you have any questions about these Terms and Conditions, please contact us at <a href="mailto:contact@receiptgenerator.net" className="text-navy-600 hover:text-navy-800 underline">contact@receiptgenerator.net</a>.</p>
          </div>
        </div>
      </div>
    </Layout>
