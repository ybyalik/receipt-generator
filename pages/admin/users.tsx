          ...
          <form onSubmit={handleSearch} className="flex gap-4">
            ...
            {searchQuery && (
              <button
                ...
                className="bg-gray-100 text-gray-700 px-6 py-2 rounded-lg font-semibold hover:bg-gray-200 transition-colors cursor-pointer"
              >
                Clear
              </button>
            )}
            ...
            <table className="w-full">
              <thead className="bg-gray-50 border-b border-gray-200">
                <tr>
                  ...
                  <th className="text-left py-3 px-4 text-gray-900 font-semibold">Plan</th>
                  <th className="text-left py-3 px-4 text-gray-900 font-semibold">Status</th>
                  <th className="text-left py-3 px-4 text-gray-900 font-semibold">Subscription Ends</th>
                  <th className="text-left py-3 px-4 text-gray-900 font-semibold">Joined</th>
                    ...
                    <tr key={userData.id} className="border-b border-gray-100 hover:bg-gray-50">
                      <td className="py-4 px-4">
                        <div>
                          ...
                          {userData.isPremium && (
                            <span className="inline-flex items-center text-xs text-teal-600 mt-1">
                      ...
                      <td className="py-4 px-4">
                        <div className="flex gap-2">
                          <button
                            ...
                            className="p-2 bg-teal-100 text-teal-600 rounded-lg hover:bg-teal-200 transition-colors cursor-pointer"
                            title="Edit User"
                          >
                            <FiEdit2 />
                          </button>
