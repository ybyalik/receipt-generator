...
export default function About() {
  return (
    <Layout>
      ...
      <div className="min-h-screen bg-gradient-to-br from-navy-50 via-white to-accent-50">
        <div className="max-w-4xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h1 className="text-5xl font-bold text-navy-900 mb-4">About Receipt Generator</h1>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="bg-white rounded-xl shadow-md p-8 border border-navy-100">
              ...
              <h3 className="text-xl font-semibold text-navy-900 mb-3">Fast & Simple</h3>
            ...
            <div className="bg-white rounded-xl shadow-md p-8 border border-navy-100">
              ...
              <h3 className="text-xl font-semibold text-navy-900 mb-3">Professional Quality</h3>
              <p className="text-navy-600 leading-relaxed">
          ...
          <div className="bg-gradient-to-br from-navy-900 to-accent-900 rounded-2xl shadow-xl p-8 md:p-12 text-white">
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                <FiCheckCircle className="text-accent-400 mt-1 mr-3 flex-shrink-0" size={24} />
                <div>
