      ...
      <div className="min-h-screen bg-gray-50 py-12">
        <div className="max-w-4xl mx-auto px-4">
          <div className="bg-white rounded-lg shadow-md p-8">
            ...
            <h2 className="text-2xl font-bold text-navy-900 mt-8 mb-4">2. How We Use Information</h2>
            ...
            <h2 className="text-2xl font-bold text-navy-900 mt-8 mb-4">3. Storage and Retention</h2>
            <p>Generated receipts may be stored temporarily on our servers for operational purposes. These receipts are not linked to personal user identities. Users can request deletion of stored receipts by contacting us at <a href="mailto:contact@receiptgenerator.net" className="text-navy-600 hover:text-navy-800 underline">contact@receiptgenerator.net</a>.</p>

            <h2 className="text-2xl font-bold text-navy-900 mt-8 mb-4">4. Cookies</h2>
            ...
            <h2 className="text-2xl font-bold text-navy-900 mt-8 mb-4">5. Data Security</h2>
            ...
            <p>To exercise these rights, contact us at <a href="mailto:contact@receiptgenerator.net" className="text-navy-600 hover:text-navy-800 underline">contact@receiptgenerator.net</a>.</p>

            <h2 className="text-2xl font-bold text-navy-900 mt-8 mb-4">9. Updates to This Policy</h2>
            ...
            <h2 className="text-2xl font-bold text-navy-900 mt-8 mb-4">10. Contact Information</h2>
            <p>If you have any questions about this Privacy Policy or our data practices, please contact us at <a href="mailto:contact@receiptgenerator.net" className="text-navy-600 hover:text-navy-800 underline">contact@receiptgenerator.net</a>.</p>
